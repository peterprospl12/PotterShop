 ...
 *}
<div class="col-md-6 links" style="width:100%">
  <div class="row">
  {foreach $linkBlocks as $linkBlock}
    <div class="col-md-6 wrapper" style="width: calc(100% / 6)">
      <p class="h3 hidden-sm-down link-block-headers-changed harry-potter-font-class" styles="font-family: HarryP">{$linkBlock.title}</p>

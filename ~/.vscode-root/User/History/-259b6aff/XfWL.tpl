 ...
 *}
<div class="col-md-6 links gray-long-line" style="width:100%; padding:0;">
  <div class="row">
  {foreach $linkBlocks as $linkBlock}
    <div class="col-md-6 wrapper" style="width: calc(100% / 6); padding: 0;">
...
<hr style="height: 1px; background-color: gray; border: none; margin: 0;">
</div>
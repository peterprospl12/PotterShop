  ...
  <div class="row newsletter-big-div">
    ...
    <div class="col-md-7 col-xs-12">
      <form action="{$urls.current_url}#blockEmailSubscription_{$hookName}" method="post">
        <div class="row">
          <div class="col-xs-12">
          <img src="http://localhost:8080/themes/child_classic/modules/ps_emailsubscription/images/image.svg" alt="" title="" class="img-fluid" loading="lazy" width="1110" height="213">
            <input

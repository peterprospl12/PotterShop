    ...
    <div class="col-md-7 col-xs-12" style="width:100%">
      <form action="{$urls.current_url}#blockEmailSubscription_{$hookName}" method="post">
        <div class="row">
          ...
          <div class="col-xs-12">
              {if $conditions}
                <p>Twoje dane będą przetwarzane zgodnie z naszą polityką prywatności. Pamiętaj, że zapisując się do newslettera akceptujesz postanowienia regulaminu sklepu.</p>
              {/if}
              {if $msg}

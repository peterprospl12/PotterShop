          ...
          <div class="col-xs-12" style="padding: 0px">
              {if $conditions}
                <p style="font-size: 13px">
                  ...
                  <a href="http://localhost:8080/content/polityka-prywatnosci" title="Polityka Prywatności">polityką prywatności</a>
                  . Pamiętaj, że zapisując się do newslettera akceptujesz postanowienia
                  <a href="http://localhost:8080/content/regulamin-sklepu" title="Regulamin Sklepu"> regulaminu sklepu</a>
                  .
                </p>
              {/if}
              {if $msg}

        ...
        <div class="row">
          ...
          <div class="col-xs-12" style="padding: 0px">
              {if $conditions}
                ...
                <a id="link-cms-page-4-2" class="cms-page-link" href="http://localhost:8080/content/polityka-prywatnosci" title="polityką prywatności">
              polityką prywatności</a>
              . Pamiętaj, że zapisując się do newslettera akceptujesz postanowienia
              <a id="link-cms-page-4-2" class="cms-page-link" href="http://localhost:8080/content/regulamin-sklepu" title="polityką prywatności">
              regulaminu sklepu</a>
              .</p>
              {/if}
              {if $msg}

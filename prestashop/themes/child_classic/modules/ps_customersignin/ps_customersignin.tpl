...
<div id="_desktop_user_info">
  <div class="user-info">
    ...
    {else}
      <ul class="login-list">
        <li>
          <a href="{$urls.pages.register}" title="{l s='Create a new customer account' d='Shop.Theme.Customeraccount'}"
            rel="nofollow">
            <span class="hidden-sm-down">{l s='Sign up' d='Shop.Theme.Actions'}</span>
          </a>

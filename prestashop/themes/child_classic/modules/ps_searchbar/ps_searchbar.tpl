...
<div id="search_widget" class="search-widgets" data-search-controller-url="{$search_controller_url}">
  <form method="get" action="{$search_controller_url}" class="search-form">
    ...
    <div class="search-input-area">
      <input class="search-input" type="text" name="s" value="{$search_string}" placeholder="{l s='Szukaj' d='Shop.Theme.Catalog'}"
        aria-label="{l s='Search' d='Shop.Theme.Catalog'}">
    </div>
    <div class="search-input-area-item">
      <i class="fas fa-search search" aria-hidden="true"></i>
    </div>
